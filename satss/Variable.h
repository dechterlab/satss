...
public:
	...
	*/
	...
	static int getValueAddress(const vector<Variable*>& variables)
	{
		int add_ress=0;
		int multiplier=1;
	...
	static int getAddress (const vector<Variable*>& variables)
	{
		int add_ress=0;
		int multiplier=1;
		for(int i=0;i<variables.size();i++)
	...
	static void setAddress(const vector<Variable*>& variables, const int add_ress_)
	{
